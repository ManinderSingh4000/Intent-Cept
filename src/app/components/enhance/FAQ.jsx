...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Each contact is verified using multiple trusted data sources to ensure accuracy and compliance.",
    },
    {
      q: "Can I integrate with my CRM?",
      a: "Yes — IntentCept integrates with HighLevel, Zapier, HubSpot, and more using webhooks or API.",
    },
    {
      q: "Is it compliant with privacy laws?",
      a: "Absolutely. It’s fully cookieless and compliant with GDPR, CCPA, and other privacy regulations.",
    },
    {
      q: "Who can benefit from this?",
      a: "Agencies, marketers, and B2B businesses looking to find high-intent leads without forms or cookies.",
    },
  ];
